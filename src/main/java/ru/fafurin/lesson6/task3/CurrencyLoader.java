...
public class CurrencyLoader {
    ...
    public void writeCurrencyQuotesByDateToFile() {
        ...
        if (!source.contains("Foreign Currency Market")) throw new NoAccessToCbrData();
        if (source.contains("Foreign Currency Market\"></ValCurs>")) throw new NoCurrencyValueForThisDate();
    ...
    private String formatString(String source, String currentValueId) {
        if (source.contains(currentValueId)) {
            ...
            return date + ": " + value;
        } else throw new CurrencyValueNotFoundException();
    }
